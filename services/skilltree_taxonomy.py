...
SKILLTREE_OUTLINE = {
    ...
    "geometriya": {
        "name": {"uz": "Geometriya", "ru": "Геометрия", "en": "Geometry"},
        "icon": "triangle",
        "color": "#FF9600",
        "units": [
            {
                "slug": "planimetriya-asoslari",
                "title": {"uz": "Planimetriya asoslari", "ru": "Основы планиметрии", "en": "Foundations of plane geometry"},
                "lessons": [
                    {"slug": "nuqta-chiziq-kesma", "title": {"uz": "Nuqta, chiziq, kesma va nur", "ru": "Точка, линия, отрезок и луч", "en": "Point, line, segment and ray"}},
                    {"slug": "burchak-turlari", "title": {"uz": "Burchak va uning turlari", "ru": "Угол и его виды", "en": "Angle and its types"}},
                    {"slug": "qoshni-vertikal-burchak", "title": {"uz": "Qo'shni va vertikal burchaklar", "ru": "Смежные и вертикальные углы", "en": "Adjacent and vertical angles"}},
                    {"slug": "perpendikulyar-chiziqlar", "title": {"uz": "Perpendikulyar chiziqlar", "ru": "Перпендикулярные прямые", "en": "Perpendicular lines"}},
                    {"slug": "parallel-chiziqlar", "title": {"uz": "Parallel chiziqlar", "ru": "Параллельные прямые", "en": "Parallel lines"}},
                    {"slug": "parallel-kesuvchi", "title": {"uz": "Parallel chiziqlar va kesuvchi", "ru": "Параллельные прямые и секущая", "en": "Parallel lines and a transversal"}},
                    {"slug": "geometriya-aksiomalari", "title": {"uz": "Geometriyaning asosiy aksiomalari", "ru": "Основные аксиомы геометрии", "en": "Basic axioms of geometry"}},
                    {"slug": "geometrik-yasashlar", "title": {"uz": "Sirkul va chizg'ich bilan yasashlar", "ru": "Построения циркулем и линейкой", "en": "Constructions with compass and straightedge"}},
                    {"slug": "uzunlik-burchak-olchash", "title": {"uz": "Uzunlik va burchakni o'lchash", "ru": "Измерение длины и угла", "en": "Measuring length and angle"}},
                    {"slug": "tekislik-figuralari", "title": {"uz": "Tekislik figuralari haqida tushuncha", "ru": "Понятие о плоских фигурах", "en": "Plane figures: an overview"}},
                ],
            },
            {
                "slug": "uchburchaklar",
                "title": {"uz": "Uchburchaklar", "ru": "Треугольники", "en": "Triangles"},
                "lessons": [
                    {"slug": "uchburchak-turlari", "title": {"uz": "Uchburchak va uning turlari", "ru": "Треугольник и его виды", "en": "Triangle and its types"}},
                    {"slug": "uchburchak-burchaklari", "title": {"uz": "Uchburchak burchaklari yig'indisi", "ru": "Сумма углов треугольника", "en": "Sum of a triangle's angles"}},
                    {"slug": "uchburchak-tengligi", "title": {"uz": "Uchburchaklar tengligi alomatlari", "ru": "Признаки равенства треугольников", "en": "Triangle congruence tests"}},
                    {"slug": "teng-yonli-uchburchak", "title": {"uz": "Teng yonli va teng tomonli uchburchak", "ru": "Равнобедренный и равносторонний треугольник", "en": "Isosceles and equilateral triangles"}},
                    {"slug": "togri-burchakli-uchburchak", "title": {"uz": "To'g'ri burchakli uchburchak", "ru": "Прямоугольный треугольник", "en": "Right triangle"}},
                    {"slug": "pifagor-teoremasi", "title": {"uz": "Pifagor teoremasi", "ru": "Теорема Пифагора", "en": "The Pythagorean theorem"}},
                    {"slug": "uchburchak-chiziqlari", "title": {"uz": "Mediana, bissektrisa va balandlik", "ru": "Медиана, биссектриса и высота", "en": "Median, bisector and altitude"}},
                    {"slug": "uchburchak-muhim-nuqtalari", "title": {"uz": "Uchburchakning muhim nuqtalari", "ru": "Замечательные точки треугольника", "en": "Notable points of a triangle"}},
                    {"slug": "uchburchak-orta-chizigi", "title": {"uz": "Uchburchakning o'rta chizig'i", "ru": "Средняя линия треугольника", "en": "Midsegment of a triangle"}},
                    {"slug": "uchburchaklar-oxshashligi", "title": {"uz": "Uchburchaklar o'xshashligi", "ru": "Подобие треугольников", "en": "Similarity of triangles"}},
                    {"slug": "uchburchak-yuzi", "title": {"uz": "Uchburchak yuzi", "ru": "Площадь треугольника", "en": "Area of a triangle"}},
                    {"slug": "uchburchak-tengsizligi", "title": {"uz": "Uchburchak tengsizligi", "ru": "Неравенство треугольника", "en": "The triangle inequality"}},
                ],
            },
            {
                "slug": "torturchak-kopburchak",
                "title": {"uz": "To'rtburchaklar va ko'pburchaklar", "ru": "Четырёхугольники и многоугольники", "en": "Quadrilaterals and polygons"},
                "lessons": [
                    {"slug": "torturchak-tushuncha", "title": {"uz": "To'rtburchak haqida tushuncha", "ru": "Понятие о четырёхугольнике", "en": "The quadrilateral"}},
                    {"slug": "parallelogramm", "title": {"uz": "Parallelogramm va uning xossalari", "ru": "Параллелограмм и его свойства", "en": "Parallelogram and its properties"}},
                    {"slug": "togri-torturchak", "title": {"uz": "To'g'ri to'rtburchak", "ru": "Прямоугольник", "en": "Rectangle"}},
                    {"slug": "romb", "title": {"uz": "Romb", "ru": "Ромб", "en": "Rhombus"}},
                    {"slug": "kvadrat", "title": {"uz": "Kvadrat", "ru": "Квадрат", "en": "Square"}},
                    {"slug": "trapetsiya", "title": {"uz": "Trapetsiya", "ru": "Трапеция", "en": "Trapezoid"}},
                    {"slug": "trapetsiya-orta-chizigi", "title": {"uz": "Trapetsiya o'rta chizig'i", "ru": "Средняя линия трапеции", "en": "Midsegment of a trapezoid"}},
                    {"slug": "torturchak-yuzi", "title": {"uz": "To'rtburchaklar yuzi", "ru": "Площади четырёхугольников", "en": "Areas of quadrilaterals"}},
                    {"slug": "kopburchak-burchaklari", "title": {"uz": "Ko'pburchak va uning burchaklari", "ru": "Многоугольник и его углы", "en": "Polygon and its angles"}},
                    {"slug": "muntazam-kopburchak", "title": {"uz": "Muntazam ko'pburchaklar", "ru": "Правильные многоугольники", "en": "Regular polygons"}},
                    {"slug": "kopburchak-yuzi", "title": {"uz": "Ko'pburchak yuzi", "ru": "Площадь многоугольника", "en": "Area of a polygon"}},
                ],
            },
            {
                "slug": "aylana-doira",
                "title": {"uz": "Aylana va doira", "ru": "Окружность и круг", "en": "Circle and disk"},
                "lessons": [
                    {"slug": "aylana-elementlari", "title": {"uz": "Aylana va uning elementlari", "ru": "Окружность и её элементы", "en": "Circle and its elements"}},
                    {"slug": "vatar-yoy", "title": {"uz": "Vatar va yoy", "ru": "Хорда и дуга", "en": "Chord and arc"}},
                    {"slug": "markaziy-ichki-burchak", "title": {"uz": "Markaziy va ichki chizilgan burchak", "ru": "Центральный и вписанный угол", "en": "Central and inscribed angles"}},
                    {"slug": "aylanaga-urinma", "title": {"uz": "Aylanaga urinma", "ru": "Касательная к окружности", "en": "Tangent to a circle"}},
                    {"slug": "uchburchak-ichki-tashqi-aylana", "title": {"uz": "Uchburchakka ichki va tashqi chizilgan aylana", "ru": "Вписанная и описанная окружность треугольника", "en": "Incircle and circumcircle of a triangle"}},
                    {"slug": "torturchak-aylana", "title": {"uz": "Aylanaga ichki va tashqi chizilgan to'rtburchak", "ru": "Вписанный и описанный четырёхугольник", "en": "Inscribed and circumscribed quadrilaterals"}},
                    {"slug": "aylana-uzunligi", "title": {"uz": "Aylana uzunligi", "ru": "Длина окружности", "en": "Circumference"}},
                    {"slug": "doira-yuzi", "title": {"uz": "Doira yuzi", "ru": "Площадь круга", "en": "Area of a disk"}},
                    {"slug": "sektor-segment-yuzi", "title": {"uz": "Sektor va segment yuzi", "ru": "Площадь сектора и сегмента", "en": "Area of a sector and a segment"}},
                ],
            },
            {
                "slug": "vektor-koordinata",
                "title": {"uz": "Vektorlar va koordinatalar", "ru": "Векторы и координаты", "en": "Vectors and coordinates"},
                "lessons": [
                    {"slug": "vektor-tushuncha", "title": {"uz": "Vektor haqida tushuncha", "ru": "Понятие о векторе", "en": "The vector"}},
                    {"slug": "vektor-amallar", "title": {"uz": "Vektorlar ustida amallar", "ru": "Действия над векторами", "en": "Operations on vectors"}},
                    {"slug": "vektor-koordinatalari", "title": {"uz": "Vektorning koordinatalari", "ru": "Координаты вектора", "en": "Coordinates of a vector"}},
                    {"slug": "skalyar-kopaytma", "title": {"uz": "Vektorlarning skalyar ko'paytmasi", "ru": "Скалярное произведение векторов", "en": "Dot product of vectors"}},
                    {"slug": "koordinata-tekisligi", "title": {"uz": "Koordinatalar tekisligi", "ru": "Координатная плоскость", "en": "The coordinate plane"}},
                    {"slug": "ikki-nuqta-masofa", "title": {"uz": "Ikki nuqta orasidagi masofa", "ru": "Расстояние между двумя точками", "en": "Distance between two points"}},
                    {"slug": "kesma-orta-koordinata", "title": {"uz": "Kesma o'rtasining koordinatalari", "ru": "Координаты середины отрезка", "en": "Midpoint coordinates"}},
                    {"slug": "togri-chiziq-tenglamasi", "title": {"uz": "To'g'ri chiziq tenglamasi", "ru": "Уравнение прямой", "en": "Equation of a line"}},
                    {"slug": "aylana-tenglamasi", "title": {"uz": "Aylana tenglamasi", "ru": "Уравнение окружности", "en": "Equation of a circle"}},
                ],
            },
            {
                "slug": "almashtirish-trigonometriya",
                "title": {"uz": "Almashtirishlar va trigonometriya", "ru": "Преобразования и тригонометрия", "en": "Transformations and trigonometry"},
                "lessons": [
                    {"slug": "simmetriya", "title": {"uz": "Simmetriya: o'q va markazga nisbatan", "ru": "Симметрия: осевая и центральная", "en": "Axial and central symmetry"}},
                    {"slug": "parallel-kochirish", "title": {"uz": "Parallel ko'chirish", "ru": "Параллельный перенос", "en": "Translation"}},
                    {"slug": "burish", "title": {"uz": "Burish (aylantirish)", "ru": "Поворот", "en": "Rotation"}},
                    {"slug": "gomotetiya", "title": {"uz": "Gomotetiya va o'xshashlik", "ru": "Гомотетия и подобие", "en": "Homothety and similarity"}},
                    {"slug": "trigonometrik-nisbatlar", "title": {"uz": "To'g'ri burchakli uchburchakda trigonometrik nisbatlar", "ru": "Тригонометрические отношения в прямоугольном треугольнике", "en": "Trigonometric ratios in a right triangle"}},
                    {"slug": "sinuslar-teoremasi", "title": {"uz": "Sinuslar teoremasi", "ru": "Теорема синусов", "en": "The law of sines"}},
                    {"slug": "kosinuslar-teoremasi", "title": {"uz": "Kosinuslar teoremasi", "ru": "Теорема косинусов", "en": "The law of cosines"}},
                    {"slug": "uchburchakni-yechish", "title": {"uz": "Uchburchakni yechish", "ru": "Решение треугольников", "en": "Solving triangles"}},
                ],
            },
            {
                "slug": "stereometriya",
                "title": {"uz": "Stereometriya", "ru": "Стереометрия", "en": "Solid geometry"},
                "lessons": [
                    {"slug": "fazoda-chiziq-tekislik", "title": {"uz": "Fazoda to'g'ri chiziq va tekislik", "ru": "Прямая и плоскость в пространстве", "en": "Lines and planes in space"}},
                    {"slug": "fazoda-parallellik", "title": {"uz": "Fazoda parallellik", "ru": "Параллельность в пространстве", "en": "Parallelism in space"}},
                    {"slug": "fazoda-perpendikulyarlik", "title": {"uz": "Fazoda perpendikulyarlik", "ru": "Перпендикулярность в пространстве", "en": "Perpendicularity in space"}},
                    {"slug": "ikki-yoqli-burchak", "title": {"uz": "Ikki yoqli burchak", "ru": "Двугранный угол", "en": "Dihedral angle"}},
                    {"slug": "prizma", "title": {"uz": "Prizma", "ru": "Призма", "en": "Prism"}},
                    {"slug": "parallelepiped", "title": {"uz": "Parallelepiped va kub", "ru": "Параллелепипед и куб", "en": "Parallelepiped and cube"}},
                    {"slug": "piramida", "title": {"uz": "Piramida", "ru": "Пирамида", "en": "Pyramid"}},
                    {"slug": "silindr", "title": {"uz": "Silindr", "ru": "Цилиндр", "en": "Cylinder"}},
                    {"slug": "konus", "title": {"uz": "Konus", "ru": "Конус", "en": "Cone"}},
                    {"slug": "shar-sfera", "title": {"uz": "Shar va sfera", "ru": "Шар и сфера", "en": "Ball and sphere"}},
                    {"slug": "jismlar-hajmi", "title": {"uz": "Jismlar hajmi", "ru": "Объёмы тел", "en": "Volumes of solids"}},
                    {"slug": "jismlar-sirti", "title": {"uz": "Jismlar sirti yuzi", "ru": "Площади поверхностей тел", "en": "Surface areas of solids"}},
                ],
            },
        ],
    },
    "geografiya": {
        ...
        "units": [
            {
                "slug": "kartografiya-astronomik",
                "title": {"uz": "Kartografiya va astronomik geografiya", "ru": "Картография и астрономическая география", "en": "Cartography and astronomical geography"},
                "lessons": [
                    {"slug": "yer-shakli", "title": {"uz": "Yerning shakli va o'lchamlari", "ru": "Форма и размеры Земли", "en": "Shape and size of the Earth"}},
                    {"slug": "globus-karta", "title": {"uz": "Globus va geografik karta", "ru": "Глобус и географическая карта", "en": "Globe and geographic map"}},
                    {"slug": "masshtab", "title": {"uz": "Masshtab", "ru": "Масштаб", "en": "Scale"}},
                    {"slug": "geografik-koordinata", "title": {"uz": "Geografik koordinatalar", "ru": "Географические координаты", "en": "Geographic coordinates"}},
                    {"slug": "kartada-relyef", "title": {"uz": "Kartada relyefni tasvirlash", "ru": "Изображение рельефа на карте", "en": "Depicting relief on a map"}},
                    {"slug": "karta-turlari", "title": {"uz": "Kartalar turlari va proyeksiyalar", "ru": "Виды карт и проекции", "en": "Map types and projections"}},
                    {"slug": "quyosh-sistemasi", "title": {"uz": "Quyosh sistemasi va Yer", "ru": "Солнечная система и Земля", "en": "The Solar System and the Earth"}},
                    {"slug": "yer-oz-oqi-aylanishi", "title": {"uz": "Yerning o'z o'qi atrofida aylanishi", "ru": "Вращение Земли вокруг своей оси", "en": "The Earth's rotation on its axis"}},
                    {"slug": "yer-quyosh-aylanishi", "title": {"uz": "Yerning Quyosh atrofida aylanishi", "ru": "Обращение Земли вокруг Солнца", "en": "The Earth's revolution around the Sun"}},
                    {"slug": "vaqt-mintaqalari", "title": {"uz": "Vaqt mintaqalari", "ru": "Часовые пояса", "en": "Time zones"}},
                    {"slug": "oy-tutilishlar", "title": {"uz": "Oy va tutilishlar", "ru": "Луна и затмения", "en": "The Moon and eclipses"}},
                ],
            },
            {
                "slug": "litosfera",
                "title": {"uz": "Litosfera", "ru": "Литосфера", "en": "Lithosphere"},
                "lessons": [
                    {"slug": "yer-ichki-tuzilishi", "title": {"uz": "Yerning ichki tuzilishi", "ru": "Внутреннее строение Земли", "en": "The Earth's internal structure"}},
                    {"slug": "minerallar-togh-jinslari", "title": {"uz": "Minerallar va tog' jinslari", "ru": "Минералы и горные породы", "en": "Minerals and rocks"}},
                    {"slug": "litosfera-plitalari", "title": {"uz": "Litosfera plitalari", "ru": "Литосферные плиты", "en": "Lithospheric plates"}},
                    {"slug": "zilzilalar", "title": {"uz": "Zilzilalar", "ru": "Землетрясения", "en": "Earthquakes"}},
                    {"slug": "vulqonlar", "title": {"uz": "Vulqonlar", "ru": "Вулканы", "en": "Volcanoes"}},
                    {"slug": "yer-relyefi", "title": {"uz": "Yer yuzasi relyefi", "ru": "Рельеф земной поверхности", "en": "Relief of the Earth's surface"}},
                    {"slug": "toghlar", "title": {"uz": "Tog'lar", "ru": "Горы", "en": "Mountains"}},
                    {"slug": "tekisliklar", "title": {"uz": "Tekisliklar", "ru": "Равнины", "en": "Plains"}},
                    {"slug": "tashqi-kuchlar", "title": {"uz": "Relyefga ta'sir etuvchi tashqi kuchlar", "ru": "Внешние силы, формирующие рельеф", "en": "External forces shaping relief"}},
                    {"slug": "foydali-qazilmalar", "title": {"uz": "Foydali qazilmalar", "ru": "Полезные ископаемые", "en": "Mineral resources"}},
                ],
            },
            {
                "slug": "atmosfera",
                "title": {"uz": "Atmosfera", "ru": "Атмосфера", "en": "Atmosphere"},
                "lessons": [
                    {"slug": "atmosfera-tuzilishi", "title": {"uz": "Atmosfera tarkibi va tuzilishi", "ru": "Состав и строение атмосферы", "en": "Composition and structure of the atmosphere"}},
                    {"slug": "havo-harorati", "title": {"uz": "Havo harorati", "ru": "Температура воздуха", "en": "Air temperature"}},
                    {"slug": "atmosfera-bosimi", "title": {"uz": "Atmosfera bosimi", "ru": "Атмосферное давление", "en": "Atmospheric pressure"}},
                    {"slug": "shamollar", "title": {"uz": "Shamollar", "ru": "Ветры", "en": "Winds"}},
                    {"slug": "namlik-yoginlar", "title": {"uz": "Havo namligi va yog'inlar", "ru": "Влажность воздуха и осадки", "en": "Humidity and precipitation"}},
                    {"slug": "ob-havo", "title": {"uz": "Ob-havo", "ru": "Погода", "en": "Weather"}},
                    {"slug": "iqlim-omillari", "title": {"uz": "Iqlim va uni hosil qiluvchi omillar", "ru": "Климат и климатообразующие факторы", "en": "Climate and its controlling factors"}},
                    {"slug": "iqlim-mintaqalari", "title": {"uz": "Iqlim mintaqalari", "ru": "Климатические пояса", "en": "Climate zones"}},
                    {"slug": "atmosfera-sirkulyatsiyasi", "title": {"uz": "Atmosferaning umumiy sirkulyatsiyasi", "ru": "Общая циркуляция атмосферы", "en": "General circulation of the atmosphere"}},
                ],
            },
            {
                "slug": "gidrosfera",
                "title": {"uz": "Gidrosfera", "ru": "Гидросфера", "en": "Hydrosphere"},
                "lessons": [
                    {"slug": "gidrosfera-suv-aylanishi", "title": {"uz": "Gidrosfera va suvning aylanma harakati", "ru": "Гидросфера и круговорот воды", "en": "The hydrosphere and the water cycle"}},
                    {"slug": "dunyo-okeani", "title": {"uz": "Dunyo okeani", "ru": "Мировой океан", "en": "The World Ocean"}},
                    {"slug": "okean-suvi-xossalari", "title": {"uz": "Okean suvining xossalari", "ru": "Свойства океанической воды", "en": "Properties of ocean water"}},
                    {"slug": "okean-oqimlari", "title": {"uz": "Okean oqimlari", "ru": "Океанические течения", "en": "Ocean currents"}},
                    {"slug": "daryolar", "title": {"uz": "Daryolar", "ru": "Реки", "en": "Rivers"}},
                    {"slug": "kollar", "title": {"uz": "Ko'llar", "ru": "Озёра", "en": "Lakes"}},
                    {"slug": "yer-osti-suvlari", "title": {"uz": "Yer osti suvlari", "ru": "Подземные воды", "en": "Groundwater"}},
                    {"slug": "muzliklar", "title": {"uz": "Muzliklar", "ru": "Ледники", "en": "Glaciers"}},
                    {"slug": "botqoqlik-suv-omborlari", "title": {"uz": "Botqoqliklar va suv omborlari", "ru": "Болота и водохранилища", "en": "Wetlands and reservoirs"}},
                ],
            },
            {
                "slug": "biosfera-tuproq-tabiat",
                "title": {"uz": "Biosfera, tuproq va tabiat zonalari", "ru": "Биосфера, почва и природные зоны", "en": "Biosphere, soil and natural zones"},
                "lessons": [
                    {"slug": "biosfera", "title": {"uz": "Biosfera", "ru": "Биосфера", "en": "The biosphere"}},
                    {"slug": "tuproq-hosil-bolishi", "title": {"uz": "Tuproq va uning hosil bo'lishi", "ru": "Почва и её образование", "en": "Soil and its formation"}},
                    {"slug": "tuproq-turlari", "title": {"uz": "Tuproq turlari", "ru": "Типы почв", "en": "Soil types"}},
                    {"slug": "tabiat-zonalari", "title": {"uz": "Tabiat zonalari", "ru": "Природные зоны", "en": "Natural zones"}},
                    {"slug": "balandlik-mintaqalanishi", "title": {"uz": "Balandlik mintaqalanishi", "ru": "Высотная поясность", "en": "Altitudinal zonation"}},
                    {"slug": "tabiiy-komplekslar", "title": {"uz": "Tabiiy geografik komplekslar", "ru": "Природно-территориальные комплексы", "en": "Natural geographic complexes"}},
                    {"slug": "ekologik-muammolar", "title": {"uz": "Ekologik muammolar", "ru": "Экологические проблемы", "en": "Environmental problems"}},
                    {"slug": "orol-muammosi", "title": {"uz": "Orol dengizi muammosi", "ru": "Проблема Аральского моря", "en": "The Aral Sea problem"}},
                ],
            },
            {
                "slug": "aholi-iqtisodiy",
                "title": {"uz": "Aholi va iqtisodiy geografiya", "ru": "Население и экономическая география", "en": "Population and economic geography"},
                "lessons": [
                    {"slug": "aholi-soni-osishi", "title": {"uz": "Dunyo aholisi soni va o'sishi", "ru": "Численность и рост населения мира", "en": "World population size and growth"}},
                    {"slug": "aholi-joylashuvi", "title": {"uz": "Aholining joylashishi va zichligi", "ru": "Размещение и плотность населения", "en": "Population distribution and density"}},
                    {"slug": "irqlar-xalqlar", "title": {"uz": "Irqlar va xalqlar", "ru": "Расы и народы", "en": "Races and peoples"}},
                    {"slug": "aholi-migratsiyasi", "title": {"uz": "Aholi migratsiyasi", "ru": "Миграция населения", "en": "Population migration"}},
                    {"slug": "urbanizatsiya", "title": {"uz": "Urbanizatsiya va shaharlar", "ru": "Урбанизация и города", "en": "Urbanization and cities"}},
                    {"slug": "jahon-xojaligi", "title": {"uz": "Jahon xo'jaligi tarmoqlari", "ru": "Отрасли мирового хозяйства", "en": "Sectors of the world economy"}},
                    {"slug": "sanoat-geografiyasi", "title": {"uz": "Sanoat geografiyasi", "ru": "География промышленности", "en": "Geography of industry"}},
                    {"slug": "qishloq-xojaligi", "title": {"uz": "Qishloq xo'jaligi geografiyasi", "ru": "География сельского хозяйства", "en": "Geography of agriculture"}},
                    {"slug": "transport-geografiyasi", "title": {"uz": "Transport geografiyasi", "ru": "География транспорта", "en": "Geography of transport"}},
                    {"slug": "xalqaro-integratsiya", "title": {"uz": "Xalqaro iqtisodiy integratsiya", "ru": "Международная экономическая интеграция", "en": "International economic integration"}},
                ],
            },
            {
                "slug": "materiklar-mamlakatlar-ozbekiston",
                "title": {"uz": "Materiklar, mamlakatlar va O'zbekiston", "ru": "Материки, страны и Узбекистан", "en": "Continents, countries and Uzbekistan"},
                "lessons": [
                    {"slug": "materiklar-okeanlar", "title": {"uz": "Materiklar va okeanlar", "ru": "Материки и океаны", "en": "Continents and oceans"}},
                    {"slug": "yevrosiyo", "title": {"uz": "Yevrosiyo", "ru": "Евразия", "en": "Eurasia"}},
                    {"slug": "afrika", "title": {"uz": "Afrika", "ru": "Африка", "en": "Africa"}},
                    {"slug": "shimoliy-amerika", "title": {"uz": "Shimoliy Amerika", "ru": "Северная Америка", "en": "North America"}},
                    {"slug": "janubiy-amerika", "title": {"uz": "Janubiy Amerika", "ru": "Южная Америка", "en": "South America"}},
                    {"slug": "avstraliya-okeaniya", "title": {"uz": "Avstraliya va Okeaniya", "ru": "Австралия и Океания", "en": "Australia and Oceania"}},
                    {"slug": "antarktida", "title": {"uz": "Antarktida", "ru": "Антарктида", "en": "Antarctica"}},
                    {"slug": "ozbekiston-orni-relyefi", "title": {"uz": "O'zbekiston geografik o'rni va relyefi", "ru": "Географическое положение и рельеф Узбекистана", "en": "Uzbekistan: location and relief"}},
                    {"slug": "ozbekiston-iqlim-suvlari", "title": {"uz": "O'zbekiston iqlimi va suvlari", "ru": "Климат и воды Узбекистана", "en": "Uzbekistan: climate and waters"}},
                    {"slug": "ozbekiston-tabiat-zonalari", "title": {"uz": "O'zbekiston tabiat zonalari", "ru": "Природные зоны Узбекистана", "en": "Uzbekistan: natural zones"}},
                    {"slug": "ozbekiston-aholisi", "title": {"uz": "O'zbekiston aholisi", "ru": "Население Узбекистана", "en": "Population of Uzbekistan"}},
                    {"slug": "ozbekiston-iqtisodiyoti", "title": {"uz": "O'zbekiston iqtisodiyoti", "ru": "Экономика Узбекистана", "en": "Economy of Uzbekistan"}},
                    {"slug": "ozbekiston-viloyatlar", "title": {"uz": "O'zbekiston hududiy bo'linishi", "ru": "Административное деление Узбекистана", "en": "Administrative divisions of Uzbekistan"}},
                ],
            },
        ],
    },
    "psixologiya": {
        "name": {"uz": "Psixologiya", "ru": "Психология", "en": "Psychology"},
        "icon": "brain",
        "color": "#CE82FF",
        "units": [
            {
                "slug": "psixologiya-asoslari",
                "title": {"uz": "Psixologiya asoslari va tadqiqot metodlari", "ru": "Основы психологии и методы исследования", "en": "Foundations of psychology and research methods"},
                "lessons": [
                    {"slug": "psixologiya-fani", "title": {"uz": "Psixologiya fani va uning predmeti", "ru": "Психология как наука и её предмет", "en": "Psychology as a science and its subject"}},
                    {"slug": "psixologiya-tarixi", "title": {"uz": "Psixologiya tarixi", "ru": "История психологии", "en": "History of psychology"}},
                    {"slug": "psixologiya-yondashuvlari", "title": {"uz": "Psixologiyadagi asosiy yo'nalishlar", "ru": "Основные подходы в психологии", "en": "Major approaches in psychology"}},
                    {"slug": "tadqiqot-metodlari", "title": {"uz": "Tadqiqot metodlari", "ru": "Методы исследования", "en": "Research methods"}},
                    {"slug": "eksperimental-metod", "title": {"uz": "Eksperimental metod va o'zgaruvchilar", "ru": "Экспериментальный метод и переменные", "en": "The experimental method and variables"}},
                    {"slug": "korrelyatsion-tadqiqot", "title": {"uz": "Korrelyatsion tadqiqot", "ru": "Корреляционное исследование", "en": "Correlational research"}},
                    {"slug": "malumotlar-tahlili", "title": {"uz": "Ma'lumotlar tahlili va statistika", "ru": "Анализ данных и статистика", "en": "Data analysis and statistics"}},
                    {"slug": "tadqiqot-etikasi", "title": {"uz": "Tadqiqot etikasi", "ru": "Этика исследований", "en": "Research ethics"}},
                    {"slug": "psixologiya-tarmoqlari", "title": {"uz": "Psixologiyaning tarmoqlari", "ru": "Отрасли психологии", "en": "Subfields of psychology"}},
                ],
            },
            {
                "slug": "biologik-asoslar",
                "title": {"uz": "Xulq-atvorning biologik asoslari", "ru": "Биологические основы поведения", "en": "Biological bases of behavior"},
                "lessons": [
                    {"slug": "neyron-tuzilishi", "title": {"uz": "Neyron tuzilishi", "ru": "Строение нейрона", "en": "Structure of a neuron"}},
                    {"slug": "nerv-impulsi", "title": {"uz": "Nerv impulsi", "ru": "Нервный импульс", "en": "The neural impulse"}},
                    {"slug": "neyromediatorlar", "title": {"uz": "Neyromediatorlar", "ru": "Нейромедиаторы", "en": "Neurotransmitters"}},
                    {"slug": "nerv-sistemasi", "title": {"uz": "Nerv sistemasi", "ru": "Нервная система", "en": "The nervous system"}},
                    {"slug": "endokrin-sistema", "title": {"uz": "Endokrin sistema va gormonlar", "ru": "Эндокринная система и гормоны", "en": "The endocrine system and hormones"}},
                    {"slug": "miya-tuzilishi", "title": {"uz": "Miya tuzilishi va vazifalari", "ru": "Строение и функции мозга", "en": "Brain structure and function"}},
                    {"slug": "miyani-organish", "title": {"uz": "Miyani o'rganish usullari", "ru": "Методы изучения мозга", "en": "Methods of studying the brain"}},
                    {"slug": "irsiyat-muhit", "title": {"uz": "Irsiyat va muhit", "ru": "Наследственность и среда", "en": "Nature and nurture"}},
                    {"slug": "uyqu-tushlar", "title": {"uz": "Uyqu va tushlar", "ru": "Сон и сновидения", "en": "Sleep and dreams"}},
                    {"slug": "ong-holatlari", "title": {"uz": "Ong va uning holatlari", "ru": "Сознание и его состояния", "en": "Consciousness and its states"}},
                ],
            },
            {
                "slug": "sezgi-idrok",
                "title": {"uz": "Sezgi va idrok", "ru": "Ощущение и восприятие", "en": "Sensation and perception"},
                "lessons": [
                    {"slug": "sezgi-idrok-tushuncha", "title": {"uz": "Sezgi va idrok tushunchasi", "ru": "Понятие ощущения и восприятия", "en": "Sensation and perception defined"}},
                    {"slug": "korish", "title": {"uz": "Ko'rish sezgisi", "ru": "Зрение", "en": "Vision"}},
                    {"slug": "eshitish", "title": {"uz": "Eshitish sezgisi", "ru": "Слух", "en": "Hearing"}},
                    {"slug": "tam-hid", "title": {"uz": "Ta'm va hid sezgilari", "ru": "Вкус и обоняние", "en": "Taste and smell"}},
                    {"slug": "teri-tana-sezgi", "title": {"uz": "Teri va tana sezgilari", "ru": "Кожные и телесные ощущения", "en": "Touch and body senses"}},
                    {"slug": "idrokni-tashkil", "title": {"uz": "Idrokni tashkil etish (Gestalt)", "ru": "Организация восприятия (гештальт)", "en": "Perceptual organization (Gestalt)"}},
                    {"slug": "chuqurlik-idroki", "title": {"uz": "Chuqurlik va harakat idroki", "ru": "Восприятие глубины и движения", "en": "Depth and motion perception"}},
                    {"slug": "idrok-omillari", "title": {"uz": "Idrokka ta'sir etuvchi omillar", "ru": "Факторы, влияющие на восприятие", "en": "Influences on perception"}},
                ],
            },
            {
                "slug": "organish",
                "title": {"uz": "O'rganish", "ru": "Научение", "en": "Learning"},
                "lessons": [
                    {"slug": "klassik-shartlanish", "title": {"uz": "Klassik shartlanish", "ru": "Классическое обусловливание", "en": "Classical conditioning"}},
                    {"slug": "operant-shartlanish", "title": {"uz": "Operant shartlanish", "ru": "Оперантное обусловливание", "en": "Operant conditioning"}},
                    {"slug": "mustahkamlash-jazo", "title": {"uz": "Mustahkamlash va jazo", "ru": "Подкрепление и наказание", "en": "Reinforcement and punishment"}},
                    {"slug": "mustahkamlash-jadvali", "title": {"uz": "Mustahkamlash jadvallari", "ru": "Режимы подкрепления", "en": "Schedules of reinforcement"}},
                    {"slug": "kuzatuv-orqali", "title": {"uz": "Kuzatuv orqali o'rganish", "ru": "Научение через наблюдение", "en": "Observational learning"}},
                    {"slug": "kognitiv-organish", "title": {"uz": "Kognitiv o'rganish", "ru": "Когнитивное научение", "en": "Cognitive learning"}},
                    {"slug": "organish-biologik", "title": {"uz": "O'rganishning biologik omillari", "ru": "Биологические факторы научения", "en": "Biological factors in learning"}},
                ],
            },
            {
                "slug": "kognitiv-psixologiya",
                "title": {"uz": "Kognitiv psixologiya: xotira va tafakkur", "ru": "Когнитивная психология: память и мышление", "en": "Cognitive psychology: memory and thinking"},
                "lessons": [
                    {"slug": "xotira-jarayonlari", "title": {"uz": "Xotira jarayonlari", "ru": "Процессы памяти", "en": "Memory processes"}},
                    {"slug": "xotira-turlari", "title": {"uz": "Xotira turlari", "ru": "Виды памяти", "en": "Types of memory"}},
                    {"slug": "xotirani-mustahkamlash", "title": {"uz": "Xotirani mustahkamlash", "ru": "Улучшение памяти", "en": "Improving memory"}},
                    {"slug": "unutish", "title": {"uz": "Unutish", "ru": "Забывание", "en": "Forgetting"}},
                    {"slug": "xotira-xatolari", "title": {"uz": "Xotira xatolari", "ru": "Ошибки памяти", "en": "Memory errors"}},
                    {"slug": "tafakkur-muammo", "title": {"uz": "Tafakkur va muammo yechish", "ru": "Мышление и решение задач", "en": "Thinking and problem solving"}},
                    {"slug": "qaror-evristika", "title": {"uz": "Qaror qabul qilish va evristikalar", "ru": "Принятие решений и эвристики", "en": "Decision making and heuristics"}},
                    {"slug": "til-nutq", "title": {"uz": "Til va nutq", "ru": "Язык и речь", "en": "Language"}},
                    {"slug": "intellekt", "title": {"uz": "Intellekt va uni o'lchash", "ru": "Интеллект и его измерение", "en": "Intelligence and its measurement"}},
                ],
            },
            {
                "slug": "rivojlanish-motivatsiya-emotsiya",
                "title": {"uz": "Rivojlanish, motivatsiya va emotsiya", "ru": "Развитие, мотивация и эмоции", "en": "Development, motivation and emotion"},
                "lessons": [
                    {"slug": "rivojlanish-psixologiyasi", "title": {"uz": "Rivojlanish psixologiyasi", "ru": "Психология развития", "en": "Developmental psychology"}},
                    {"slug": "kognitiv-rivojlanish", "title": {"uz": "Kognitiv rivojlanish (Piaje)", "ru": "Когнитивное развитие (Пиаже)", "en": "Cognitive development (Piaget)"}},
                    {"slug": "ijtimoiy-rivojlanish", "title": {"uz": "Ijtimoiy va emotsional rivojlanish", "ru": "Социально-эмоциональное развитие", "en": "Social and emotional development"}},
                    {"slug": "axloqiy-rivojlanish", "title": {"uz": "Axloqiy rivojlanish", "ru": "Нравственное развитие", "en": "Moral development"}},
                    {"slug": "osmirlik-yetuklik", "title": {"uz": "O'smirlik va yetuklik davri", "ru": "Подростковый и взрослый возраст", "en": "Adolescence and adulthood"}},
                    {"slug": "motivatsiya", "title": {"uz": "Motivatsiya nazariyalari", "ru": "Теории мотивации", "en": "Theories of motivation"}},
                    {"slug": "emotsiya", "title": {"uz": "Emotsiya nazariyalari", "ru": "Теории эмоций", "en": "Theories of emotion"}},
                    {"slug": "stress-soglik", "title": {"uz": "Stress va sog'liq", "ru": "Стресс и здоровье", "en": "Stress and health"}},
                ],
            },
            {
                "slug": "shaxs-ruhiy-ijtimoiy",
                "title": {"uz": "Shaxs, ruhiy salomatlik va ijtimoiy psixologiya", "ru": "Личность, психическое здоровье и социальная психология", "en": "Personality, mental health and social psychology"},
                "lessons": [
                    {"slug": "shaxs-psixoanaliz", "title": {"uz": "Psixoanalitik shaxs nazariyasi", "ru": "Психоаналитическая теория личности", "en": "Psychoanalytic theory of personality"}},
                    {"slug": "shaxs-gumanistik", "title": {"uz": "Gumanistik shaxs nazariyasi", "ru": "Гуманистическая теория личности", "en": "Humanistic theory of personality"}},
                    {"slug": "shaxs-xususiyatlar", "title": {"uz": "Xususiyatlar nazariyasi", "ru": "Теория черт личности", "en": "Trait theory"}},
                    {"slug": "shaxsni-baholash", "title": {"uz": "Shaxsni baholash", "ru": "Оценка личности", "en": "Personality assessment"}},
                    {"slug": "ruhiy-buzilishlar", "title": {"uz": "Ruhiy buzilishlar tushunchasi", "ru": "Понятие психических расстройств", "en": "Understanding psychological disorders"}},
                    {"slug": "xavotir-buzilishlari", "title": {"uz": "Xavotir buzilishlari", "ru": "Тревожные расстройства", "en": "Anxiety disorders"}},
                    {"slug": "kayfiyat-buzilishlari", "title": {"uz": "Kayfiyat buzilishlari", "ru": "Расстройства настроения", "en": "Mood disorders"}},
                    {"slug": "shizofreniya", "title": {"uz": "Shizofreniya", "ru": "Шизофрения", "en": "Schizophrenia"}},
                    {"slug": "psixoterapiya", "title": {"uz": "Psixoterapiya va davolash", "ru": "Психотерапия и лечение", "en": "Psychotherapy and treatment"}},
                    {"slug": "ijtimoiy-tasir", "title": {"uz": "Ijtimoiy ta'sir: konformizm va itoat", "ru": "Социальное влияние: конформизм и подчинение", "en": "Social influence: conformity and obedience"}},
                    {"slug": "ijtimoiy-idrok", "title": {"uz": "Ijtimoiy idrok va munosabatlar", "ru": "Социальное познание и установки", "en": "Social cognition and attitudes"}},
                    {"slug": "guruh-psixologiyasi", "title": {"uz": "Guruh psixologiyasi", "ru": "Психология групп", "en": "Group psychology"}},
                ],
            },
        ],
    },
